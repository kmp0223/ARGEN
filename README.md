...
- Tutorial 5: [Robustness to GEM group](/tutorials/Tutorial5-Fig_4c.ipynb) — re-fitting ARGEN with GEM group as a covariate (Fig. 4c)
- Tutorial 6: [Robustness to dropping genes](/tutorials/Tutorial6-Fig_4d_e_f.ipynb) — re-fitting ARGEN after dropping the confounding gene MED12 (Fig. 4d–f)
- Tutorial 7: [3D genomics-based exploration](/tutorials/Tutorial7-Fig_5a_b.ipynb) — edge strength vs. genomic distance and A/B compartment (Fig. 5a–b)
- Tutorial 8: [External validation](/tutorials/Tutorial8-Fig_5c_d.ipynb) — validating ARGEN edges against TAD co-membership and ChIP-seq overlap (Fig. 5c–d)
- Tutorial 9: [Inter-chromosomal network](/tutorials/Tutorial9-Fig_6_7.ipynb) — the pooled, genome-wide ARGEN fit, module/GO characterization, and hub visualization (Fig. 6–7)
