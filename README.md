...
- Tutorial 1: [Simulation study](https://github.com/kmp0223/ARGEN/blob/main/tutorials/Tutorial1-Fig.2.ipynb) — comparing ARGEN, Naive, and INSPRE (Brown et al., 2025, Nature Communications) on a synthetic DAG (Fig. 2)
- Tutorial 2: [Single-chromosome application](/tutorials/Tutorial2-Fig.3a%2Cb%2Cc.ipynb) — the MCM3 sub-DAG and intervention effects (Fig. 3a–c)
- Tutorial 3: [Across-chromosome application](/tutorials/Tutorial3-Fig.3d%2Ce%2Cf%2Cg.ipynb) — ARGEN and INSPRE (Brown et al., 2025, Nature Communications) across all chromosomes (Fig. 3d–g)
- Tutorial 4: [Confounding diagnostics](/tutorials/Tutorial4-Fig.4a%2Cb.ipynb) — checking the perturbation indicator against GEM group / mitochondrial percentage (Fig. 4a–b)
- Tutorial 5: [Robustness to GEM group](/tutorials/Tutorial5-Fig.4c.ipynb) — re-fitting ARGEN with GEM group as a covariate (Fig. 4c)
- Tutorial 6: [Robustness to dropping genes](/tutorials/Tutorial6-Fig.4d%2Ce%2Cf.ipynb) — re-fitting ARGEN after dropping the confounding gene MED12 (Fig. 4d–f)
- Tutorial 7: [3D genomics-based exploration](/tutorials/Tutorial7-Fig.5a%2Cb.ipynbb) — edge strength vs. genomic distance and A/B compartment (Fig. 5a–b)
- Tutorial 8: [External validation](/tutorials/Tutorial8-Fig.5c%2Cd.ipynb) — validating ARGEN edges against TAD co-membership and ChIP-seq overlap (Fig. 5c–d)
- Tutorial 9: [Inter-chromosomal network](/tutorials/Tutorial9-Fig.6%2C7.ipynb) — the pooled, genome-wide ARGEN fit, module/GO characterization, and hub visualization (Fig. 6–7)
