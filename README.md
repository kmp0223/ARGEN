...
The processed data from Replogle et al. (2022, Cell), along with auxiliary data, are available via Google Drive at: [Google Drive link](https://drive.google.com/drive/u/0/folders/1luFVh6laubmLKERc0wWDYh3k8_gCCVv0). The raw data is available ate [the link provided by Replogle et al.](https://gwps.wi.mit.edu/).
## Reference
